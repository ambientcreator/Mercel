...
//
// RU: Р§С‚Рѕ РґРµР»Р°РµС‚: РЅРѕСЂРјР°Р»РёР·СѓРµС‚ Рё РѕРіСЂР°РЅРёС‡РёРІР°РµС‚ РІРµСЃР°, РїСЂРёС€РµРґС€РёРµ СЃ С„СЂРѕРЅС‚РµРЅРґР°, РїРѕ С‚РµРєСѓС‰РµРјСѓ СЃРїРёСЃРєСѓ СѓСЃР»СѓРі.
// EN: What it does: normalizes and clamps frontend-provided weights against the current service list.
//
// RU: РљР»СЋС‡РµРІС‹Рµ РјРѕРјРµРЅС‚С‹: РЅРµ СЃРѕР·РґР°С‘С‚ Р»РёС€РЅРёРµ СѓСЃР»СѓРіРё; РґР»СЏ РѕС‚СЃСѓС‚СЃС‚РІСѓСЋС‰РёС… РІРµСЃРѕРІ РѕСЃС‚Р°РІР»СЏРµС‚ Р·РЅР°С‡РµРЅРёРµ 0.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `solveStructuredAllocation`.
// EN: Function `solveStructuredAllocation`.
//
// RU: Р В§РЎвЂљР С• Р Т‘Р ВµР В»Р В°Р ВµРЎвЂљ: РЎС“РЎвЂЎР В°РЎРѓРЎвЂљР Р†РЎС“Р ВµРЎвЂљ Р Р†Р С• Р Р†Р Р…РЎС“РЎвЂљРЎР‚Р ВµР Р…Р Р…Р ВµР в„– Р СР В°РЎвЂљР ВµР СР В°РЎвЂљР С‘Р С”Р Вµ РЎР‚Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљР В° Р С‘ РЎвЂљР С•РЎвЂЎР Р…Р С•Р С РЎР‚Р В°РЎРѓР С—РЎР‚Р ВµР Т‘Р ВµР В»Р ВµР Р…Р С‘Р С‘ РЎРѓРЎС“Р СР СРЎвЂ№.
...
//
// RU: Р С™Р В»РЎР‹РЎвЂЎР ВµР Р†РЎвЂ№Р Вµ Р СР С•Р СР ВµР Р…РЎвЂљРЎвЂ№: РЎРЏР Р†Р В»РЎРЏР ВµРЎвЂљРЎРѓРЎРЏ РЎвЂЎР В°РЎРѓРЎвЂљРЎРЉРЎР‹ РЎР‚Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљР Р…Р С•Р С–Р С• Р С—Р В°Р в„–Р С—Р В»Р В°Р в„–Р Р…Р В°; РЎвЂЎРЎС“Р Р†РЎРѓРЎвЂљР Р†Р С‘РЎвЂљР ВµР В»Р ВµР Р… Р С” Р С–РЎР‚Р В°Р Р…Р С‘РЎвЂЎР Р…РЎвЂ№Р С РЎРѓР В»РЎС“РЎвЂЎР В°РЎРЏР С; РЎвЂљРЎР‚Р ВµР В±РЎС“Р ВµРЎвЂљ РЎвЂљР ВµРЎРѓРЎвЂљР С•Р Р†Р С•Р в„– Р С—РЎР‚Р С•Р Р†Р ВµРЎР‚Р С”Р С‘ Р С—Р С•РЎРѓР В»Р Вµ Р С—РЎР‚Р В°Р Р†Р С•Р С”.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `chooseGroupTargets`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `reserveMinimumServices`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `buildServiceTargets`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `buildCategoryRatios`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `applyWeightAdjustments`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `transferShare`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `reachableAmounts`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `candidateAmounts`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `allocateByRatios`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `sumTargets`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `bestGroupAllocation`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `serviceAllocationScore`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `absInt`.
// EN: Function `absInt`.
//
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `solveExact`.
...
// RU: Р В¤РЎС“Р Р…Р С”РЎвЂ Р С‘РЎРЏ `mergeGroupQuantities`.
...
// RU: Р СљР ВµРЎвЂљР С•Р Т‘ `SaveCalculation`.
