...
func TestAdminAccountIsRestoredAndHiddenFromUserList(t *testing.T) {
	...
	if !visibleWorker {
		t.Fatalf("expected created worker to be present in list users")
	}
}
...
func TestAuthenticatedUserCanCalculateAndSave(t *testing.T) {
	...
	saved, err := app.SaveCalculation(SaveCalculationRequest{Title: "Архивный расчёт", TargetAmount: result.TargetAmount, Items: result.Items})
	if err != nil {
...
func TestCalculationSourceMessagesStayReadable(t *testing.T) {
	sourcePath := filepath.Join("..", "appcore", "app_calculation.go")
	...
	if !strings.Contains(source, "\\u0412\\u0432\\u0435\\u0434\\u0438\\u0442\\u0435 \\u0441\\u0443\\u043c\\u043c\\u0443 \\u0431\\u043e\\u043b\\u044c\\u0448\\u0435 0.") {
		t.Fatalf("expected readable validation message for zero amount")
	}
	if !strings.Contains(source, "\\u041d\\u0435 \\u0443\\u0434\\u0430\\u043b\\u043e\\u0441\\u044c \\u043f\\u043e\\u0434\\u043e\\u0431\\u0440\\u0430\\u0442\\u044c \\u0442\\u043e\\u0447\\u043d\\u044b\\u0439 \\u0440\\u0430\\u0441\\u0447\\u0451\\u0442 \\u043d\\u0430 \\u0441\\u0443\\u043c\\u043c\\u0443") {
