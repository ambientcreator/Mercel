...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestBootstrapSeedsServices`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestNewUserStartsWithoutServicesAndSeesOnlyOwnServices`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestAdminCanCreateService`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestAdminCanCreateAndPromoteUser`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestSeniorSpecialistCanCreateEmployee`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestManagerCanCreateEmployeeAndSeniorSpecialist`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestCreateUserAdminRoleFallsBackToEmployee`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestAdminAccountIsRestoredAndHiddenFromUserList`.
...
func TestAdminAccountIsRestoredAndHiddenFromUserList(t *testing.T) {
	...
	_, err = db.Exec(`INSERT INTO users(username, password_hash, role, created_at) VALUES(?, ?, ?, ?)`, "admin", HashPasswordForTest("broken"), RoleEmployee, "2026-03-27T00:00:00Z")
	if err != nil {
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestAuthenticatedUserCanCalculateAndSave`.
...
// RU: Р В РЎв„ўР В Р’В»Р РЋР вЂ№Р РЋРІР‚РЋР В Р’ВµР В Р вЂ Р РЋРІР‚в„–Р В Р’Вµ Р В РЎВР В РЎвЂўР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р РЋРІР‚в„–: Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В Р’В°Р В Р’ВµР РЋРІР‚С™ Р В Р вЂ  Р В РЎвЂР В Р’В·Р В РЎвЂўР В Р’В»Р В РЎвЂР РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р’В°Р В Р вЂ¦Р В Р вЂ¦Р В РЎвЂўР В РЎВ Р РЋР С“Р РЋРІР‚В Р В Р’ВµР В Р вЂ¦Р В Р’В°Р РЋР вЂљР В РЎвЂР В РЎвЂ; Р В Р вЂ¦Р РЋРЎвЂњР В Р’В¶Р В Р’ВµР В Р вЂ¦ Р В РўвЂР В Р’В»Р РЋР РЏ Р В Р’В·Р В Р’В°Р РЋРІР‚В°Р В РЎвЂР РЋРІР‚С™Р РЋРІР‚в„– Р В РЎвЂўР РЋРІР‚С™ Р РЋР вЂљР В Р’ВµР В РЎвЂ“Р РЋР вЂљР В Р’ВµР РЋР С“Р РЋР С“Р В РЎвЂР В РІвЂћвЂ“; Р В РўвЂР В РЎвЂўР В РЎвЂќР РЋРЎвЂњР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р В РЎвЂР РЋР вЂљР РЋРЎвЂњР В Р’ВµР РЋРІР‚С™ Р В РЎвЂўР В Р’В¶Р В РЎвЂР В РўвЂР В Р’В°Р В Р’ВµР В РЎВР В РЎвЂўР В Р’Вµ Р В РЎвЂ”Р В РЎвЂўР В Р вЂ Р В Р’ВµР В РўвЂР В Р’ВµР В Р вЂ¦Р В РЎвЂР В Р’Вµ.
// EN: Key points: runs in an isolated scenario; protects against regressions; documents the expected behavior of the feature or rule.
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestSeededTestAdminIsVisibleAndDeletableByProtectedAdmin`.
// EN: Test `TestSeededTestAdminIsVisibleAndDeletableByProtectedAdmin`.
//
// RU: Р В Р’В§Р РЋРІР‚С™Р В РЎвЂў Р В РўвЂР В Р’ВµР В Р’В»Р В Р’В°Р В Р’ВµР РЋРІР‚С™: Р В РЎвЂ”Р РЋР вЂљР В РЎвЂўР В Р вЂ Р В Р’ВµР РЋР вЂљР РЋР РЏР В Р’ВµР РЋРІР‚С™, Р РЋРІР‚РЋР РЋРІР‚С™Р В РЎвЂў Р РЋРІР‚С™Р В Р’ВµР РЋР С“Р РЋРІР‚С™Р В РЎвЂўР В Р вЂ Р В Р’В°Р РЋР РЏ Р РЋРЎвЂњР РЋРІР‚РЋР РЋРІР‚ВР РЋРІР‚С™Р В РЎвЂќР В Р’В° admin1 Р РЋР С“Р В РЎвЂўР В Р’В·Р В РўвЂР В Р’В°Р РЋРІР‚ВР РЋРІР‚С™Р РЋР С“Р РЋР РЏ Р В Р’В°Р В Р вЂ Р РЋРІР‚С™Р В РЎвЂўР В РЎВР В Р’В°Р РЋРІР‚С™Р В РЎвЂР РЋРІР‚РЋР В Р’ВµР РЋР С“Р В РЎвЂќР В РЎвЂ, Р В Р вЂ Р В РЎвЂР В РўвЂР В Р вЂ¦Р В Р’В° Р В РЎвЂќР В Р’В°Р В РЎвЂќ Р В РЎвЂўР В Р’В±Р РЋРІР‚в„–Р РЋРІР‚РЋР В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р В РЎвЂ”Р В РЎвЂўР В Р’В»Р РЋР Р‰Р В Р’В·Р В РЎвЂўР В Р вЂ Р В Р’В°Р РЋРІР‚С™Р В Р’ВµР В Р’В»Р РЋР Р‰ Р В РЎвЂ Р В РЎВР В РЎвЂўР В Р’В¶Р В Р’ВµР РЋРІР‚С™ Р В Р’В±Р РЋРІР‚в„–Р РЋРІР‚С™Р РЋР Р‰ Р РЋРЎвЂњР В РўвЂР В Р’В°Р В Р’В»Р В Р’ВµР В Р вЂ¦Р В Р’В° Р В Р’В·Р В Р’В°Р РЋРІР‚В°Р В РЎвЂР РЋРІР‚В°Р РЋРІР‚ВР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РЎВ admin.
...
//
// RU: Р В РЎв„ўР В Р’В»Р РЋР вЂ№Р РЋРІР‚РЋР В Р’ВµР В Р вЂ Р РЋРІР‚в„–Р В Р’Вµ Р В РЎВР В РЎвЂўР В РЎВР В Р’ВµР В Р вЂ¦Р РЋРІР‚С™Р РЋРІР‚в„–: Р В Р’В·Р В Р’В°Р РЋРІР‚В°Р В РЎвЂР РЋРІР‚В°Р РЋРІР‚ВР В Р вЂ¦Р В Р вЂ¦Р РЋРІР‚в„–Р В РІвЂћвЂ“ admin Р В РЎвЂўР РЋР С“Р РЋРІР‚С™Р В Р’В°Р РЋРІР‚ВР РЋРІР‚С™Р РЋР С“Р РЋР РЏ Р РЋР С“Р В РЎвЂќР РЋР вЂљР РЋРІР‚в„–Р РЋРІР‚С™Р РЋРІР‚в„–Р В РЎВ; admin1 Р В РЎвЂР В РЎВР В Р’ВµР В Р’ВµР РЋРІР‚С™ Р РЋР вЂљР В РЎвЂўР В Р’В»Р РЋР Р‰ admin, Р В Р вЂ¦Р В РЎвЂў Р В Р’В±Р В Р’ВµР В Р’В· Р РЋР С“Р В РЎвЂ”Р В Р’ВµР РЋРІР‚В Р В РЎвЂР В Р’В°Р В Р’В»Р РЋР Р‰Р В Р вЂ¦Р В РЎвЂўР В РІвЂћвЂ“ Р В Р’В·Р В Р’В°Р РЋРІР‚В°Р В РЎвЂР РЋРІР‚С™Р РЋРІР‚в„–; Р В РЎвЂ”Р В РЎвЂўР РЋР С“Р В Р’В»Р В Р’Вµ Р РЋРЎвЂњР В РўвЂР В Р’В°Р В Р’В»Р В Р’ВµР В Р вЂ¦Р В РЎвЂР РЋР РЏ Р В Р вЂ Р РЋРІР‚В¦Р В РЎвЂўР В РўвЂ Р В РЎвЂ”Р В РЎвЂўР В РўвЂ admin1 Р В РўвЂР В РЎвЂўР В Р’В»Р В Р’В¶Р В Р’ВµР В Р вЂ¦ Р В РЎвЂ”Р В Р’ВµР РЋР вЂљР В Р’ВµР РЋР С“Р РЋРІР‚С™Р В Р’В°Р РЋРІР‚С™Р РЋР Р‰ Р РЋР вЂљР В Р’В°Р В Р’В±Р В РЎвЂўР РЋРІР‚С™Р В Р’В°Р РЋРІР‚С™Р РЋР Р‰.
...
func TestAuthenticatedUserCanCalculateAndSave(t *testing.T) {
	...
	saved, err := app.SaveCalculation(SaveCalculationRequest{Title: "Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™Р В РЎвЂўР В Р вЂ Р РЋРІР‚в„–Р В РІвЂћвЂ“ Р РЋР вЂљР В Р’В°Р РЋР С“Р РЋРІР‚РЋР РЋРІР‚ВР РЋРІР‚С™", TargetAmount: result.TargetAmount, Items: result.Items})
	if err != nil {
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestStructuredCalculationKeepsServicesDistributed`.
...
func TestSaveCalculationUsesDailyTitleAndOverwritesSameDay(t *testing.T) {
	...
	expectedTitle := ArchiveDateTitleForTest(time.Now())
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestStructuredCalculationActivatesAllServicesWhenPossible`.
...
// RU: Р В РЎС›Р В Р’ВµР РЋР С“Р РЋРІР‚С™ `TestMigrationAddsCreatedByColumnForLegacyDatabase`.
...
func TestCalculationFailsWhenExactAmountIsImpossible(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "Р СњР Вµ РЎС“Р Т‘Р В°Р В»Р С•РЎРѓРЎРЉ Р С—Р С•Р Т‘Р С•Р В±РЎР‚Р В°РЎвЂљРЎРЉ РЎвЂљР С•РЎвЂЎР Р…РЎвЂ№Р в„– РЎР‚Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљ") {
...
func TestCalculationSourceMessagesStayReadable(t *testing.T) {
	...
	if !strings.Contains(source, "Р вЂ™Р Р†Р ВµР Т‘Р С‘РЎвЂљР Вµ РЎРѓРЎС“Р СР СРЎС“ Р В±Р С•Р В»РЎРЉРЎв‚¬Р Вµ 0.") {
		t.Fatalf("expected readable validation message for zero amount")
	}
	if !strings.Contains(source, "Р СњР Вµ РЎС“Р Т‘Р В°Р В»Р С•РЎРѓРЎРЉ Р С—Р С•Р Т‘Р С•Р В±РЎР‚Р В°РЎвЂљРЎРЉ РЎвЂљР С•РЎвЂЎР Р…РЎвЂ№Р в„– РЎР‚Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљ") {
